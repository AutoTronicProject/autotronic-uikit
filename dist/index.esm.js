...
var ButtonMenu = function (_a) {
    var _b = _a.activeIndex, activeIndex = _b === void 0 ? 0 : _b, _c = _a.size, size = _c === void 0 ? sizes$1.MD : _c, _d = _a.variant, variant = _d === void 0 ? variants$1.PRIMARY : _d, onClick = _a.onClick, children = _a.children, className = _a.className;
...
var Modal = function (_a) {
    ...
    return (React.createElement(StyledModal, { className: className },
        React.createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React.createElement(IconButton, { className: "dialog-close-button", variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { className: "thinborder-button", "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$q, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$r, { width: "24px", color: "textSubtle" }))),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { className: "wallet-connect-modal card", title: "Connect to a wallet", onDismiss: onDismiss }, connectors.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); })));
};
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#2b7aaa", background: "rgba(0,0,0,0.3)", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#160642", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
